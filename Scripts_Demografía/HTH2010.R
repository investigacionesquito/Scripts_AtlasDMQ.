...
addWorksheet(wb, "HTH10_c", gridLines = FALSE, tabColour = "white")
writeDataTable(wb, sheet = "HTH10_c", x= HTH10_c, startRow = 1,
               rowNames = FALSE,startCol = 1,
               tableStyle = "TableStyleMedium9")
addWorksheet(wb, "HTH10_az", gridLines = FALSE, tabColour = "white")
writeDataTable(wb, sheet = "HTH10_az", x= HTH10_az, startRow = 1,
               rowNames = FALSE,startCol = 1,
               tableStyle = "TableStyleMedium9")
addWorksheet(wb, "HTH10_pr", gridLines = FALSE, tabColour = "white")
writeDataTable(wb, sheet = "HTH10_pr", x= HTH10_pr, startRow = 1,
               rowNames = FALSE,startCol = 1,
               tableStyle = "TableStyleMedium9")
addWorksheet(wb, "HTH10_s", gridLines = FALSE, tabColour = "white")
writeDataTable(wb, sheet = "HTH10_s", x= HTH10_s, startRow = 1,
               rowNames = FALSE,startCol = 1,
               tableStyle = "TableStyleMedium9")

addWorksheet(wb, "HTH10_1000", gridLines = FALSE, tabColour = "white")
writeDataTable(wb, sheet = "HTH10_1000", x= HTH10_1000, startRow = 1,
               rowNames = FALSE,startCol = 1,
               tableStyle = "TableStyleMedium9")
addWorksheet(wb, "HTH10_500", gridLines = FALSE, tabColour = "white")
writeDataTable(wb, sheet = "HTH10_500", x= HTH10_500, startRow = 1,
               rowNames = FALSE,startCol = 1,
               tableStyle = "TableStyleMedium9")
addWorksheet(wb, "HTH10_N8", gridLines = FALSE, tabColour = "white")
writeDataTable(wb, sheet = "HTH10_N8", x= HTH10_N8, startRow = 1,
               rowNames = FALSE,startCol = 1,
               tableStyle = "TableStyleMedium9")
addWorksheet(wb, "HTH10_N9", gridLines = FALSE, tabColour = "white")
writeDataTable(wb, sheet = "HTH10_N9", x= HTH10_N9, startRow = 1,
               rowNames = FALSE,startCol = 1,
               tableStyle = "TableStyleMedium9")

saveWorkbook(wb, "Porcentaje de hogares de acuerdo al tipo de hogar 2010.xlsx", overwrite = TRUE)
